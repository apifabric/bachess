...
@Component({
  selector: 'ChessBoard-home',
  templateUrl: './ChessBoard-home.component.html',
  styleUrls: ['./ChessBoard-home.component.scss']
})
export class ChessBoardHomeComponent implements AfterViewInit {
