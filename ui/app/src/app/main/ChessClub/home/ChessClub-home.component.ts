...
@Component({
  selector: 'ChessClub-home',
  templateUrl: './ChessClub-home.component.html',
  styleUrls: ['./ChessClub-home.component.scss']
})
export class ChessClubHomeComponent implements AfterViewInit {
