...
@Component({
  selector: 'PlayerTournament-home',
  templateUrl: './PlayerTournament-home.component.html',
  styleUrls: ['./PlayerTournament-home.component.scss']
})
export class PlayerTournamentHomeComponent implements AfterViewInit {
