...
@Component({
  selector: 'ClubMembership-home',
  templateUrl: './ClubMembership-home.component.html',
  styleUrls: ['./ClubMembership-home.component.scss']
})
export class ClubMembershipHomeComponent implements AfterViewInit {
