...
@Component({
  selector: 'BugReport-home',
  templateUrl: './BugReport-home.component.html',
  styleUrls: ['./BugReport-home.component.scss']
})
export class BugReportHomeComponent implements AfterViewInit {
