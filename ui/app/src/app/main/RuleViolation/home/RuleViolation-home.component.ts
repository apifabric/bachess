...
@Component({
  selector: 'RuleViolation-home',
  templateUrl: './RuleViolation-home.component.html',
  styleUrls: ['./RuleViolation-home.component.scss']
})
export class RuleViolationHomeComponent implements AfterViewInit {
