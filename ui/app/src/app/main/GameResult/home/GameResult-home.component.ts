...
@Component({
  selector: 'GameResult-home',
  templateUrl: './GameResult-home.component.html',
  styleUrls: ['./GameResult-home.component.scss']
})
export class GameResultHomeComponent implements AfterViewInit {
