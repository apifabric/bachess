...
@Component({
  selector: 'PlayerTeam-home',
  templateUrl: './PlayerTeam-home.component.html',
  styleUrls: ['./PlayerTeam-home.component.scss']
})
export class PlayerTeamHomeComponent implements AfterViewInit {
