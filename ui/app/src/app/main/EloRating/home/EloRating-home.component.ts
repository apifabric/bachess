...
@Component({
  selector: 'EloRating-home',
  templateUrl: './EloRating-home.component.html',
  styleUrls: ['./EloRating-home.component.scss']
})
export class EloRatingHomeComponent implements AfterViewInit {
