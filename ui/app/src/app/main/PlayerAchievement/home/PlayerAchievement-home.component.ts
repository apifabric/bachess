...
@Component({
  selector: 'PlayerAchievement-home',
  templateUrl: './PlayerAchievement-home.component.html',
  styleUrls: ['./PlayerAchievement-home.component.scss']
})
export class PlayerAchievementHomeComponent implements AfterViewInit {
