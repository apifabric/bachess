...
@Component({
  selector: 'Achievement-home',
  templateUrl: './Achievement-home.component.html',
  styleUrls: ['./Achievement-home.component.scss']
})
export class AchievementHomeComponent implements AfterViewInit {
